...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements johnny.HelloWorldService {
    ...
    public johnny.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            johnny.HelloWorldPortBindingStub _stub = new johnny.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (johnny.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                johnny.HelloWorldPortBindingStub _stub = new johnny.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
